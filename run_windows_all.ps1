...
$backendServerCommand = "Set-Location '$backendDir'; $pythonCommand -m uvicorn main:app --reload --host 0.0.0.0"
$pollerCommand = "Set-Location '$backendDir'; $pythonCommand poller.py"
...
Write-Host "Started backend, poller, and frontend in separate PowerShell windows."
if ($lanIp) {
