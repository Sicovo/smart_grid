...
def wifi_connect(hostname, timeout_ms=15000):
    """Connect to WiFi using credentials in wifi_config.py. Returns the WLAN
    object whether or not the connection succeeded — caller should check
    .isconnected(). Failure is non-fatal: control loop runs regardless."""
